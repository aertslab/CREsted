(() => {
    ...
    const t = (e) => "string" == typeof e && /^[v\d]/.test(e) && o.test(e),
        ...
        u = (e) => {
            ...
            if (-1 === l.indexOf(e))
                throw new Error(
                    `Invalid operator, expected one of ${l.join("|")}`,
                );
        };
    ...
    function f() {
        ...
        p(
            ((o =
                (n = m.matches
                    ? ["auto", "light", "dark"]
                    : ["auto", "dark", "light"]).indexOf(t) + 1) === n.length &&
                (o = 0),
            n[o]),
        );
    }
            ...
            const o = await (async function (e) {
                try {
                    ...
                    if (!(n instanceof TypeError)) throw n;
                    {
                        ...
                        const n = await fetch(window.location.origin, {
                            method: "HEAD",
                        });
                        t = new URL(e, n.url);
                    }
            ...
            o &&
                ...
                a &&
                    (function (e) {
                        ...
                        (l.classList =
                            "bd-header-announcement__content  ms-auto me-auto"),
    ...
    async function O() {
        const e = document.querySelector(".bd-header-announcement"),
            { pstAnnouncementUrl: t } = e.dataset;
        if (t)
            try {
                const n = await fetch(t);
                if (!n.ok)
    ...
    e(async function () {
        ...
        e.classList.remove("d-none");
        const t = Array.from(e.children).reduce(
        ...
        e(function () {
            window.addEventListener("activate.bs.scrollspy", function () {
                document.querySelectorAll(".bd-toc-nav a").forEach((e) => {
                    ...
                    document
                        .querySelectorAll(".bd-toc-nav a.active")
                        .forEach((e) => {
                ...
                e.forEach((e) => {
                    0 !== e.addedNodes.length &&
                        ...
                        e.addedNodes.forEach((e) => {
                            document
                                .getElementById("rtd-footer-container")
                                .append(e);
                        });
                });
