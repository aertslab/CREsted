...
The model is a CNN multiclass regression model using the :func:`~crested.tl.zoo.dilated_cnn` architecture. The training data can be downloaded with `crested.get_dataset('mouse_cortex_bigwig_coverage')`.
