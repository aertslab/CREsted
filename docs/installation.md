...
3. Current Keras 3.0 is in active development and some features (mainly multi GPU training and weights and biases logging) are available earlier in the TensorFlow backend. If you plan on using these features, you should choose TensorFlow.
