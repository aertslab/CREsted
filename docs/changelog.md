...
- Plotting logo-based contribution scores ({func}`crested.pl.explain.contribution_scores` & co) now use `fast-logomaker` instead of `logomaker`, which is substantially faster. (#231, #237)
