...
def EnhancerOptimizer(*args, **kwargs):
    ...
    logger.info(
        "`crested.utils.EnhancerOptimizer` has been moved to `crested.pl.design.EnhancerOptimizer` in version 1.7.0"
...
def _weighted_difference(*args, **kwargs):
    ...
    logger.info(
        "`crested.utils._weighted_difference` has been moved to `crested.pl.design._optimizer._weighted_difference` in version 1.7.0"
        " and this alias will be removed in a future release. Please use its new name instead."
    )
...
def derive_intermediate_sequences(*args, **kwargs):
    ...
    logger.info(
        "`crested.utils.derive_intermediate_sequences` has been renamed to `crested.pl.design.derive_intermediate_sequences` in version 1.7.0"
        " and this alias will be removed in a future release. Please use its new name instead."
    )
