...
def enhancer_design_in_silico_evolution(*args, **kwargs):
    ...
    """
    logger.info(
        "`crested.tl.enhancer_design_in_silico_evolution` has been renamed to `crested.pl.design.in_silico_evolution` in version 1.7.0"
...
def enhancer_design_motif_insertion(*args, **kwargs):
    ...
    """
    logger.info(
        "`crested.tl.enhancer_design_motif_insertion` has been renamed to `crested.pl.design.motif_insertion` in version 1.7.0"
        " and this alias will be removed in a future release. Please use its new name instead."
    )
